...
public class FileLogger : LoggerServiceBase
{
    ...
    public FileLogger(IConfiguration configuration)
    {
        ...
        FileLogConfiguration logConfiguration = _configuration.GetSection("SeriLogConfigurations:FileLogConfiguration").Get<FileLogConfiguration>()?? throw new Exception(SerilogMessages.NullOptionMessage);
